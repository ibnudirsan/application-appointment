...
const totalAppointmentsCout = ref(0);
...
const getAppointmentsCount = () => {
    axios
        ...
        .then((response) => {
            totalAppointmentsCout.value = response.data.totalAppointmentsCout;
        })
        .catch((error) => {
            console.log(error);
        });
                    ...
                    <div class="small-box bg-info">
                        <div class="inner">
                            <div class="d-flex justify-content-between">
                                <h3>{{ totalAppointmentsCout }}</h3>
                                <select v-model="selectedAppointmentStatus" @change="getAppointmentsCount()" style="height: 2rem; outline: 2px solid transparent;"
                    ...
                    <div class="small-box bg-info">
                        <div class="inner">
                            <div class="d-flex justify-content-between">
                                ...
                                <select v-model="selectedDateRange" @change="getUsersCount()" style="height: 2rem; outline: 2px solid transparent;"
                                    class="px-1 rounded border-0">
